package com.iamcanincan.hardcrop.update
...
object UpdateChecker {
  ...
  private val ENDPOINTS =
    listOf(
      "https://api.github.com/repos/IamCanincan/HardCrop/releases/latest",
      "https://gh-proxy.com/https://api.github.com/repos/IamCanincan/HardCrop/releases/latest",
    )

  /** GitHub API 不带 User-Agent 会直接回 403，所以必须带一个。 */
  private const val USER_AGENT = "HardCrop"
